...
public class ModDataComponents {
    ...
    public static final DataComponentType<BlockPos> DEBUG_BLOCKPOS = Registry.register(
            BuiltInRegistries.DATA_COMPONENT_TYPE, Identifier.fromNamespaceAndPath(LifeLocke.MOD_ID, "debug_blockpos"),
