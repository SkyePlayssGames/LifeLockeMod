...
public class SoundSettingsScreen extends Screen {
    ...
    protected void init() {
        ButtonWidget toggleSwitchButton = ButtonWidget.builder(Text.translatable("text.lifelocke.modmenu.toggle_switch.button"),
                new SoundSwitchButtonPressAction(this.client,
                        SettingsFileHandler.SETTINGS.POWER_SOUND_TOGGLE.ordinal(),
                        SettingsFileHandler.SETTINGS.POWER_SOUND_TOGGLE_ORDER.ordinal(),
                        "text.lifelocke.modmenu.set_setting.toggle_switch.description"
                )
        ...
        ButtonWidget activeSwitchButton = ButtonWidget.builder(Text.translatable("text.lifelocke.modmenu.active_switch.button"),
                new SoundSwitchButtonPressAction(this.client,
                        SettingsFileHandler.SETTINGS.POWER_SOUND_ACTIVE.ordinal(),
                        SettingsFileHandler.SETTINGS.POWER_SOUND_ACTIVE_ORDER.ordinal(),
                        "text.lifelocke.modmenu.set_setting.active_switch.description"
                )
